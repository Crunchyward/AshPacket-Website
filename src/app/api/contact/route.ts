...
const TOPIC_LABELS: Record<string, string> = {
  ...
  "project-setup": "One-time project: setup / rebuild",
  "project-migration": "One-time project: migration",
  "project-hardening": "One-time project: hardening",
  "project-other": "One-time project: other",
